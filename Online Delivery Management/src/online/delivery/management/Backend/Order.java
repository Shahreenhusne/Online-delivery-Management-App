...
public class Order {
    ...
    Order() {
        ...
        orderList.add(new IndianFood("Chicken Butter Masala", 320));
        orderList.add(new IndianFood("Kadhai Paneer", 250));
        orderList.add(new IndianFood("Vegetable Jalfrezi", 220));
        orderList.add(new IndianFood("Dal Makhani", 220));
        orderList.add(new IndianFood("Butter Naan", 60));
...
class IndianFood extends FoodItem {
    
    IndianFood(String name, int price) {
        super(name, price);
    }
}
